...
class AnalyzeEnergy(ut.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.system.thermostat.set_langevin(kT=0.0, gamma=1.0, seed=42)
    ...
    def test_kinetic(self):
        ...
        self.assertAlmostEqual(energy["total"], 25.0, delta=1e-7)
        self.assertAlmostEqual(energy["kinetic_lin"], 25.0, delta=1e-7)
        self.assertAlmostEqual(energy["kinetic_rot"], 0.0, delta=1e-7)
        self.assertAlmostEqual(energy["kinetic"], 25.0, delta=1e-7)
        self.assertAlmostEqual(energy["bonded"], 0.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded"], 0.0, delta=1e-7)
        # two moving particles
        p1.v = [3, 4, 5]
        energy = self.system.analysis.energy()
        self.assertAlmostEqual(energy["total"], 50.0, delta=1e-7)
        self.assertAlmostEqual(energy["kinetic_lin"], 50.0, delta=1e-7)
        self.assertAlmostEqual(energy["kinetic_rot"], 0.0, delta=1e-7)
        self.assertAlmostEqual(energy["kinetic"], 50.0, delta=1e-7)
        self.assertAlmostEqual(energy["bonded"], 0.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded"], 0.0, delta=1e-7)
        if espressomd.has_features(["ROTATION"]):
            ...
            energy = self.system.analysis.energy()
            self.assertAlmostEqual(energy["kinetic_lin"], 50.0, delta=1e-7)
            self.assertAlmostEqual(energy["kinetic_rot"], 7.0, delta=1e-7)
            self.assertAlmostEqual(energy["kinetic"], 57.0, delta=1e-7)
    ...
    def test_non_bonded(self):
        ...
        p1.pos = [2, 2, 2]
        energy = self.system.analysis.energy()
        self.assertAlmostEqual(energy["total"], 1.0, delta=1e-5)
        self.assertAlmostEqual(energy["kinetic"], 0.0, delta=1e-7)
        self.assertAlmostEqual(energy["bonded"], 0.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded"], 1.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded_intra"], 1.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded_inter"], 0.0, delta=1e-7)
        ...
        self.assertAlmostEqual(
            ...
            * sum(
                [
                    self.system.analysis.particle_non_bonded_energy(p)
        ...
        energy = self.system.analysis.energy()
        self.assertAlmostEqual(energy["total"], 3.0, delta=1e-7)
        self.assertAlmostEqual(energy["kinetic"], 0.0, delta=1e-7)
        self.assertAlmostEqual(energy["bonded"], 0.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded"], 3.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded", 0, 1], 1.0, delta=1e-7)
        self.assertAlmostEqual(
            energy["non_bonded", 0, 0]
            + energy["non_bonded", 0, 1]
            + energy["non_bonded", 1, 1],
            energy["total"],
            delta=1e-7,
        )
        self.assertAlmostEqual(energy["non_bonded_intra", 0, 0], 1.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded_intra", 1, 1], 1.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded_intra", 0, 1], 0.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded_inter", 0, 0], 0.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded_inter", 1, 1], 0.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded_inter", 0, 1], 1.0, delta=1e-7)
        # Test the single particle energy function
        self.assertAlmostEqual(
            energy["non_bonded"],
            0.5
    ...
    def test_bonded(self):
        ...
        p1.delete_all_bonds()
        energy = self.system.analysis.energy()
        self.assertAlmostEqual(energy["total"], 0.0, delta=1e-7)
        self.assertAlmostEqual(energy["kinetic"], 0.0, delta=1e-7)
    ...
    def test_all(self):
        ...
        p0.add_bond((self.harmonic, p1))
        energy = self.system.analysis.energy()
        self.assertAlmostEqual(energy["total"], 50.0 + 3.0 / 2.0 + 1.0, delta=1e-7)
        self.assertAlmostEqual(energy["kinetic"], 50.0, delta=1e-7)
        self.assertAlmostEqual(energy["bonded"], 3.0 / 2.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded"], 1.0, delta=1e-7)
        self.assertAlmostEqual(
            energy["non_bonded"],
            0.5
        ...
        if espressomd.has_features(["VIRTUAL_SITES"]):
            self.assertAlmostEqual(energy["virtual_sites"], 0.0, delta=1e-7)
        if espressomd.has_features(["DPD"]):
            self.assertAlmostEqual(energy["dpd"], 0.0, delta=1e-7)
        # two bonds
        p1.add_bond((self.harmonic, p0))
        energy = self.system.analysis.energy()
        self.assertAlmostEqual(energy["total"], 50.0 + 3 + 1.0, delta=1e-7)
        self.assertAlmostEqual(energy["kinetic"], 50.0, delta=1e-7)
        self.assertAlmostEqual(energy["bonded"], 3.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded"], 1.0, delta=1e-7)
        self.assertAlmostEqual(
            energy["non_bonded"],
            0.5
        ...
        energy = self.system.analysis.energy()
        self.assertAlmostEqual(energy["total"], 50.0 + 3 + (1.0 + 1.0), delta=1e-7)
        self.assertAlmostEqual(energy["kinetic"], 50.0, delta=1e-7)
        self.assertAlmostEqual(energy["bonded"], 3.0, delta=1e-7)
        self.assertAlmostEqual(energy["non_bonded"], 1.0 + 1.0, delta=1e-7)
        self.assertAlmostEqual(
            energy["non_bonded"],
            0.5
            * sum(
